...
$result = mysqli_query($conn, "SELECT * FROM pembelian_sepatu WHERE Nomor=$id");
...
if (isset($_POST['tambah'])) {
    ...
    $sql = "UPDATE pembelian_sepatu SET 
            Nama = '$nama',
            Email = '$email',
            Ukuran = '$ukuran',
            Barang = '$barang',
        ...
        <header class="head">
            <nav>
                ...
                <ul>
                    ...
                    <li id="beli"> <a href = "buy.php" style="text-decoration: none; color: white;"> BUY </a> </li>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <table border="0" width="80%">
                    ...
                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                        ...
                        <td> <br> :</td>
                        <td> <br> <input type="text" maxlength="100" name="nama" size="50" placeholder="Nama Lengkap" required="" value = "<?php echo $spt['Nama']; ?>"></td>
                    </tr>
                    <tr>
                        <td> <br> <label for="email">Email</label></td>
                        <td> <br> : </td>
                        <td> <br> <input type="email" name="email" placeholder="Alamat Email" required="" value = "<?php echo $spt['Email']; ?>"></td>
                    </tr>
                    <tr>
                        <td> <br> <label for="ukuran">Ukuran Sepatu</label></td>
                        <td> <br> : </td>
                        <td> <br> <input type="number" name="ukuran" min="30" max="50" value="<?php echo $spt['Ukuran']; ?>"></td>
                    </tr>
                    <tr>
                        <td> <br> <label for="barang">Barang</label></td>
                        <td> <br> :</td>
                        <td> <br> <select name="barang" required="" value="<?php echo $spt['Barang']; ?>">
                            <option></option>
                    ...
                    <tr>
                        ...
                        <td> <br> : </td>
                        <td> <br> <input type="number" name="jumlah" min="1" value = "<?php echo $spt['Jumlah']; ?>"></td>
                    </tr>
                    <tr>
                        <td> <br> <label for="alamat">Alamat</label></td>
                        <td> <br> :</td>
                        <td> <br> <textarea name="alamat" placeholder="Alamat Penerima" required="" value = "<?php echo $spt['Alamat']; ?>"></textarea></td>
                    </tr>
                    <tr>
                ...
                <div class="submit">
                    ...
                    &emsp; <button type="reset" name="reset">Reset</button> 
                    &emsp; <button><a href="formbuy.php" style="text-decoration: none; color: white;">Batal</a></button>
                </div>
            </form>
        </div>
